...
public:
    ...
    void SetTileState(ETileState NewState, float MoveInterval, EGridDirection8 Direction);
...
protected:
    ...
    void OnTileStateChanged(ETileState NewState, float MoveInterval, EGridDirection8 Direction);
